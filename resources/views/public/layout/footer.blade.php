  ...
  <div class="container text-center text-md-start mt-5">
    ...
    <div class="row mt-3">
      ...
      <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
        ...
        <p>
          <a href="{{url('/#memesan')}}" class="text-reset">Cara Memesan</a>
        </p>
        <p>
          <a href="{{url('/#tentang')}}" class="text-reset">Tentang Suvis</a>
        </p>
        <p>
          <a href="{{url('/transaksi')}}" class="text-reset">Transaksi</a>
        </p>
      </div>
      <!-- Grid column -->
